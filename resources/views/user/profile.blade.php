        ...
        <div>
            @if($user->hasVerifiedEmail())
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm12">
                        <div class="card">
                            <div class="card-body">
                                <edit-profile-form :user="{{ $user }}" customers="{{ json_encode($customers) }}"></edit-profile-form>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-3">
                <div class="col-md-5 col-sm-12 mt-md-3">
                    ...
                    <p class="text-muted">Здесть вы можете изменить адрес email, сменить пароль, удалить учетную
                        запись.</p>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p>Для изменения введите ниже новый адрес email и нажмите "Сохранить адрес
                                        email".</p>
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    <p>Важно понимать: как только вы удалите свою учетную запись, назад возврата не
                                        будет.
